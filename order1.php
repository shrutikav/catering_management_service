...
<div class="row span30 main-content">
	<div class="container">
		<div class="col-md-12 enquiry">
			...
			<form action="order.php" method="post" name="application" class="form-horizontal" role="form"  >
                              
                
                <div class="form-group">
                    <label class="col-md-4 control-label">Name	:</label>
                 <div class="col-md-6">
                    <input class="form-control" name="txtName" id="txtFname" required="" type="text" >
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4 control-label">Contact No	:</label>
                 <div class="col-md-6">
                    <input class="form-control " name="txtContact"  onBlur="return ValidateEmail()" type="text">
                  </div>
                </div>
              <!--<div class="form-group">
				...
				<div class="form-group">
                 ...
                 <div class="col-md-4">
                    <input class="form-control " name="txtDate" class= "getdate" id="" type="text" >
                  </div>
                </div>
...
while ( $row = mysql_fetch_array( $sql ) ){ // Loop through the records
	...
	//echo $itemname;
	echo "<option value=$itemprice>$itemname</option>";
}
?>
